package com.critc.thymeleaf.controller;
...
import com.critc.thymeleaf.model.LearnResouce;
...
public class LearnResourceController {
    ...
    public ModelAndView index(){
        ...
        learnList.add(bean);
        bean =new LearnResouce("sdfsfsdfsf官方SpriongBoot例子","官方SpriongBoot例子","https://github.com/spring-projects/spring-boot/tree/master/spring-boot-samples");
        learnList.add(bean);
        bean =new LearnResouce("fsdfsdfsfsf龙国学院","Spring Boot 教程系列学习","http://www.roncoo.com/article/detail/125488");
        learnList.add(bean);
        bean =new LearnResouce("sdfdsfdsfsdfsdf嘟嘟MD独立博客","Spring Boot干货系列 ","http://tengj.top/");
        learnList.add(bean);
